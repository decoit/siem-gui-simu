...
app.factory('ChangesFactory', ['GraphFactory', function (GraphFactory) {
     ...
     * @returns {Array}
     */
    function convert(changesObject) {
        return Object.keys(changesObject);
    }
