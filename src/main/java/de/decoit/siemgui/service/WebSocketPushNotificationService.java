...
/**
 * Implementation of PushNotificationService that uses the Spring WebSocket module to send notifications.
 *
...
public class WebSocketPushNotificationService implements PushNotificationService {
	...
	public void sendPushNotification(String notificationText) {
		MsgPushNotification pushNote = new MsgPushNotification(notificationText);

		simpMessagingTemplate.convertAndSend("/topic/push", pushNote);
	}
}
